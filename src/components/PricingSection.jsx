...
const packages = [
    {
        ...
        popular: false,
        features: [
            { name: 'Canva Pro/Premium', included: true },
            { name: 'Gemini Pro', included: false },
            { name: 'Google Flow', included: false },
            { name: 'Google Drive 300GB', included: false },
            { name: 'CapCut Pro', included: false },
        ],
        cta: 'Pilih Starter',
        whatsappMsg: 'Halo, saya ingin membeli paket Starter 10K (Canva Pro/Premium)',
    },
    {
        name: 'Professional',
        price: '39K',
        ...
        whatsappMsg: 'Halo, saya ingin membeli paket Professional 39K (Canva Pro/Premium, Gemini, Google Flow, Google Drive 300GB)',
    },
    {
        ...
        cta: 'Pilih Ultimate',
        whatsappMsg: 'Halo, saya ingin membeli paket Ultimate 69K Pre Order (Canva Pro/Premium, Gemini, Google Flow, Google Drive 300GB, CapCut Pro)',
    },
]
